Vue.component('faq_accordion_1721904998', {
  template: `
    <div>
      <section class="leading-relaxed max-w-screen-xl mt-12 mx-auto px-4 md:px-8 bg-white">
        <div class="space-y-3 text-center">
          <h1 class="text-4xl text-gray-800 font-semibold pt-10">Your Bookworm Questions Answered</h1>
          <p class="text-gray-600 max-w-lg mx-auto text-lg">Find answers to common queries about our book-buying platform.</p>
        </div>
      ...
      faqs: [
        {
          ...
          a: "Our platform offers a vast selection of books across various genres like fiction, non-fiction, biographies, self-help, and more from renowned authors and publishers."
        },
        {
          q: "How do I place an order?",
          a: "Simply browse through our online catalog, add the books you wish to purchase to your cart, and proceed to checkout. We accept multiple payment options for your convenience."
        },
        {
          q: "Do you offer discounts or promotions?",
          a: "Yes, we regularly run discounts, deals, and promotional offers on selected titles. Make sure to sign up for our newsletter to stay updated on the latest offers."
        },
        {
          q: "What is your return policy?",
          a: "We have a hassle-free return policy. If you're not satisfied with your purchase for any reason, you can return the book within 30 days for a full refund or exchange."
        },
        {
          q: "Do you offer international shipping?",
          a: "Absolutely! We ship books worldwide. Shipping rates are calculated based on your location during checkout."
        }
      ]
    }
  },
